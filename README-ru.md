...
им пользоваться без каких-то ограничений, пока подтягиваете его по зависимостям. Если же вы захотите _взять код_ и втянуть его в свой проект, или
выпустить _форк_ данного плагина, результат должен быть опубликован так же под LGPLv3.
